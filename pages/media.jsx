...
export default function Media() {
  ...
  },
  {
    ...
    "description": "Highlights from the 2024 set."
      ...
      <style jsx>{`
        .hero{position:relative;height:38vh;min-height:240px;background:url("/banners/media.jpg") center/cover no-repeat;display:grid;place-items:center;}
        .scrim{width:100%;height:100%;display:grid;place-items:center;text-align:center;padding:1rem;background:linear-gradient(to bottom,rgba(76,0,130,.45),rgba(255,253,240,.45));backdrop-filter:saturate(120%) blur(1px);}
        ...
        .card{border-radius:16px;box-shadow:0 4px 18px rgba(0,0,0,.08);padding:1rem;background:linear-gradient(180deg,#f7f2ff 0%,#fffaf0 100%);}
        .title{margin:0 0 .5rem;font-size:1.1rem;}
        .desc{margin-top:.5rem;opacity:.85;font-size:.95rem;}
        audio,video{width:100%;border-radius:10px;display:block;margin-top:.25rem;}
      `}</style>
    </>
  );
}
