      ...
      <main className="mx-auto max-w-4xl px-4 py-10">
                ...
                <li key={v.id ?? idx} className="flex flex-col">
                  ...
                  */}
                  <div
                    ...
                    style={
                      v?.aspectRatio
                        ? { aspectRatio: v.aspectRatio } // e.g., "4 / 3" or "16 / 9"
                        : undefined
                    }
                  >
                    <video
        ...
        {audios?.length > 0 && (
          <section className="mt-12 space-y-6">
            ...
            <ul className="space-y-6">
              {audios.map((a, idx) => (
                <li key={a.id ?? idx} className="rounded-xl border border-neutral-200 p-4">
        ...
        {(!videos || videos.length === 0) && (!audios || audios.length === 0) && (
          <p className="mt-10 text-neutral-600">
            ...
            <code>/public/site-data/videos.json</code> and <code>/public/site-data/audio.json</code>.
          </
